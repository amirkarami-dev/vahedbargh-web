                  ...
                  <tbody className="divide-y divide-[var(--border)]">
                    {filtered.map((doc) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4">
                          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-600/15 hover:bg-blue-600/25 text-blue-400 text-xs font-medium transition-colors">
